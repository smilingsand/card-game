...
export const PLATFORM_EVENT_TYPES = ["game.created", "action.applied", "game.completed"] as const;
...
function assertContiguousEvents(events: readonly Event[], expectedSequence: number): void {
...
function deepFreeze<Value>(value: Value, seen = new WeakSet<object>()): Immutable<Value> {
