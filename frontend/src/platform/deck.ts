...
const STANDARD_SUITS: readonly Exclude<Suit, "joker">[] = ["spades", "hearts", "diamonds", "clubs"];
...
export function shuffleDeck(cards: readonly Card[], seed: number): readonly Card[] {
  assertSeed(seed);
...
export function validateDealConservation(deck: readonly Card[], deal: FourPlayerDeal): boolean {
