...
- P2 范围：同一前端的移动/PWA 和策略机器人；不得改变已冻结规则。当前唯一产品机器人为 normal-vNext；normal-v1 只作离线历史对照，P2.5 expert 路线已撤销，恢复必须先新增 ADR。当前本地版本为 P2.7 - normal-vNext 策略稳定化；新的 Preview/Production 验收完成前，不得将其视为新的线上发布证据。
