...
- P2 范围：同一前端的移动/PWA 和策略机器人；不得改变已冻结规则。当前唯一产品机器人为 normal-vNext；normal-v1 只作离线历史对照，P2.5 expert 路线已撤销，恢复必须先新增 ADR。当前版本为 P2.7 - normal-vNext 策略稳定化，已部署到 Vercel Production；新的 Preview 或移动端/PWA 人工验收不得以历史证据替代。
