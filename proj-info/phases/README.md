...
| [P2](P2/README.md) | 已完成；P2.7 已部署 Production | 移动/PWA、normal-vNext 产品策略和发布记录。 |
...
- P2.7 - normal-vNext 策略稳定化已在本地和 GitHub 版本化，并于 2026-07-23 部署到 Vercel Production；正式入口为 `https://card-game-wentop.vercel.app/`。
