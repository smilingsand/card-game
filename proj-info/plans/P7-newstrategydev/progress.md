...
- **状态：** accepted（2026-08-27 已完成 Preview/Production 验收）。
...
- 2026-08-27：P7 已合入 `main` 并完成 Preview、Production 验收；详情见 `proj-info/phases/P7/release.md`。
...
- **状态：** P7-00 至 P7-23 均为 accepted；P7-05 已于 2026-08-27 完成 Preview 与 Production 验收。
